...
export default {
  ...
  methods: {
    ...
    send: function() {
      ...
      window.ws.sendMsg("/app/sendGroup", msg)
      this.input = ""
    }, 
    manage: function() {
      location = "/manageGroup/" + this.groupId
    },
    hello: function() {
      console.log("hello")
    }
  ...
  mounted: function() {
    var that = this
    window.bus.subscribe('groupChat', function(param){
      console.log(param)
      var m = {
    ...
    this.groupName = this.$route.params.data.groupName
